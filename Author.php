...
#[ORM\Entity(repositoryClass: AuthorRepository::class)] //class bch twali table ORM\Entity//changer author
class Author
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'author', targetEntity: Book::class)] //relation one to many
